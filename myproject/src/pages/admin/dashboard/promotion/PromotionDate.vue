...
<va-card class="p-4">
    ...
    <va-data-table :items="items" :columns="columns">
        ...
        <template #cell(actions)="{ row, isExpanded }">
            ...
            <va-button icon="edit" @click="editItem(row.rowData)" color="warning" icon-color="#812E9E" class="mr-1" />
            <va-button icon="delete" @click="delItem(row.rowData.id)" color="danger" icon-color="#ffffff" class="" />
        </template>
