<template>
    <va-button size="large" class="mr-3 mb-2" @click="showModal = true">
    ...
    <va-modal class="z-50" v-model="showModal" close-button hide-default-actions blur>
        ...
        <va-form ref="formRef" class="grid  grid-cols-3 gap-4 mb-6">
            <va-select class="w-fit" v-model="selThu" label="Thứ" :options="opThu" required-mark="" />
            <!-- <va-time-input v-model="startTime" class="" clearable label="Giờ bắt đầu" required-mark="" />
            <va-time-input v-model="endTime" class="" clearable label="Giờ kết thúc" required-mark="" /> -->
...
function formatTime(e) {
    return moment.tz(e, 'Asia/Ho_Chi_Minh').format('HH:mm')
}
</script>
