<template>
  <div class="auth-layout grid grid-cols-12 content-center">
    <div class="flex col-span-12 p-4 justify-center text-8xl font-bold text-blue-600">
      LSEC
    </div>
    <!-- <div class="flex col-span-12 p-4 justify-center text-5xl font-bold text-blue-600">
      Đăng nhập
    </div> -->
      ...
      <va-card class="auth-layout__card">
        <va-card-content>
          <!-- <va-tabs v-model="tabIndex" center>
            <template #tabs>
              <va-tab name="login">Đăng nhập</va-tab>
