  ...
  <va-navbar class="app-layout-navbar">
    <template #left>
      <div class="left">
        ...
        <router-link to="/">
          <!-- <vuestic-logo  /> -->
          <img class="logo w-24  lg:w-36 " src="/Life Skills Education Center-logos_transparent.png" alt="">
    ...
    <div class="app-navbar-center">
      ...
      <va-button href="https://github.com/epicmaxco/vuestic-admin" color="#000000" class="hidden lg:block" icon="github"
        target="_blank">
        {{ t('navbar.repository') }}
      </va-button>
    </div>
