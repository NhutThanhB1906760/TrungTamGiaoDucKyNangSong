  ...
  <div class="app-layout">
    ...
    <div class="app-layout__content">
      ...
      <div class="app-layout__page">
        ...
        <div class="bg-sky-700 p-4">
          <h6 class="text-white text-center text-lg">Website được phát triển bởi Nguyễn Nhựt Thanh</h6>
          <h6 class="text-white text-center text-lg">Đồ án tốt nghiệp Kỹ thuật phần mềm K45 - Đại Học Cần Thơ</h6>
...
const handleMessage = (mes) => {
  console.log(convert(mes));

  sendData(convert(mes))
}
